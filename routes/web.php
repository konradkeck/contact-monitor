...
// Synchronizer Wizard (outside require.setup — needed for initial server setup)
...
// Synchronizer Servers (outside require.setup)
...
// Synchronizer Connections (require.setup enforced by group middleware)
