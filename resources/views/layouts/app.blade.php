...
<div class="flex flex-1">
    ...
    <main id="main-content" class="flex-1 min-w-0" style="margin-left: {{ $mainMargin }};">
        ...
        {{-- Flash messages --}}
        @if(session('success'))
            <div class="px-6 py-2.5 text-sm border-b bg-green-50 border-green-200 text-green-800 flex items-center gap-3">
        ...
        @endif
        @if(session('error'))
            <div class="px-6 py-2.5 text-sm border-b bg-red-50 border-red-200 text-red-800 flex items-center gap-3">
