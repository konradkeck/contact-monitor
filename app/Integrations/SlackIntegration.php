...
class SlackIntegration extends BaseIntegration
{
    ...
    {
        // White Slack hash on aubergine background (official Slack brand dark variant)
        return '<svg class="'.$sizeClass.'" viewBox="0 0 54 54" fill="white" xmlns="http://www.w3.org/2000/svg">
